...
intellisense.annotate(jQuery, {
  ...
  'boxModel': function() {
    /// <summary>Deprecated in jQuery 1.3 (see jQuery.support). States if the current page, in the user's browser, is being rendered using the W3C ~/Content Box Model.</summary>
  ...
  '~/ContentHooks': function() {
    /// <summary>Hook directly into jQuery to override how particular ~/Content properties are retrieved or set, normalize ~/Content property naming, or create custom properties.</summary>
    /// <returns type="Object" />
  },
  'data': function() {
    /// <signature>
  ...
  'get': function() {
    ...
    ///   <param name="dataType" type="String">The type of data expected from the server. Default: Intelligent Guess (xml, ~/Scriptson, script, or html).</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  'get~/ScriptsON': function() {
    /// <signature>
    ///   <summary>Load ~/ScriptsON-encoded data from the server using a GET HTTP request.</summary>
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
  ...
  'parse~/ScriptsON': function() {
    /// <signature>
    ///   <summary>Takes a well-formed ~/ScriptsON string and returns the resulting JavaScript object.</summary>
    ///   <param name="~/Scriptson" type="String">The ~/ScriptsON string to parse.</param>
    ///   <returns type="Object" />
    /// </signature>
  },
  'parseXML': function() {
  ...
  'post': function() {
    ...
    ///   <param name="data" type="String">A plain object or string that is sent to the server with the request.</param>
    ///   <param name="success(data, textStatus, jqXHR)" type="Function">A callback function that is executed if the request succeeds.</param>
    ///   <param name="dataType" type="String">The type of data expected from the server. Default: Intelligent Guess (xml, ~/Scriptson, script, text, html).</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  'proxy': function() {
...
intellisense.annotate(jQuery.fn, {
  ...
  'animate': function() {
    /// <signature>
    ///   <summary>Perform a custom animation of a set of ~/Content properties.</summary>
    ///   <param name="properties" type="PlainObject">An object of ~/Content properties and values that the animation will move toward.</param>
  ...
  '~/Content': function() {
    /// <signature>
    ///   <summary>Set one or more ~/Content properties for the set of matched elements.</summary>
    ///   <param name="propertyName" type="String">A ~/Content property name.</param>
  ...
  'height': function() {
    /// <signature>
    ///   <summary>Set the ~/Content height of every matched element.</summary>
  ...
  'init': function() {
    /// <signature>
    ///   <summary>Accepts a string containing a ~/Content selector which is then used to match a set of elements.</summary>
  ...
  'width': function() {
    /// <signature>
    ///   <summary>Set the ~/Content width of each element in the set of matched elements.</summary>
