        ...
        var _InternalLogMessage = (function () {
            function _InternalLogMessage(msgId, msg, properties) {
                ...
                var diagnosticText = (msg ? " message:" + _InternalLogMessage.sanitizeDiagnosticText(msg) : "") +
                    (properties ? " props:" + _InternalLogMessage.sanitizeDiagnosticText(~/ScriptsON.stringify(properties)) : "");
    ...
    (function (ApplicationInsights) {
        ...
        var Util = (function () {
            ...
            Util.dump = function (object) {
                ...
                var propertyValueDump = ~/ScriptsON.stringify(object);
    ...
    (function (ApplicationInsights) {
        ...
        var Serializer = (function () {
            ...
            Serializer.serialize = function (input) {
                ...
                return ~/ScriptsON.stringify(output);
            };
    ...
    (function (ApplicationInsights) {
        ...
        var ArraySendBuffer = (function () {
            ...
            ArraySendBuffer.prototype.batchPayloads = function (payload) {
                if (payload && payload.length > 0) {
                    var batch = this._config.emitLineDelimited~/Scriptson() ?
                        payload.join("\n") :
                        "[" + payload.join(",") + "]";
                    return batch;
                }
        ...
        var SessionStorageSendBuffer = (function () {
            ...
            SessionStorageSendBuffer.prototype.getBuffer = function (key) {
                try {
                    var buffer~/Scriptson = ApplicationInsights.Util.getSessionStorage(key);
                    if (buffer~/Scriptson) {
                        var buffer = ~/ScriptsON.parse(buffer~/Scriptson);
                        if (buffer) {
                            return buffer;
                        }
                    }
            ...
            SessionStorageSendBuffer.prototype.setBuffer = function (key, buffer) {
                try {
                    var buffer~/Scriptson = ~/ScriptsON.stringify(buffer);
                    ApplicationInsights.Util.setSessionStorage(key, buffer~/Scriptson);
                }
                catch (e) {
    ...
    (function (ApplicationInsights) {
        ...
        var Sender = (function () {
            ...
            Sender.prototype._xhrSender = function (payload, isAsync) {
                ...
                xhr.setRequestHeader("Content-type", "application/~/Scriptson");
                ...
                PageVisitTimeManager.prototype.startPageVisitTimer = function (pageName, pageUrl) {
                    try {
                        if (ApplicationInsights.Util.canUseSessionStorage()) {
                            ...
                            var currPageVisitDataStr = ~/ScriptsON.stringify(currPageVisitData);
                ...
                PageVisitTimeManager.prototype.stopPageVisitTimer = function () {
                    try {
                        if (ApplicationInsights.Util.canUseSessionStorage()) {
                            ...
                            var pageVisitData~/ScriptsonStr = ApplicationInsights.Util.getSessionStorage(this.prevPageVisitDataKeyName);
                            if (pageVisitData~/ScriptsonStr) {
                                var prevPageVisitData = ~/ScriptsON.parse(pageVisitData~/ScriptsonStr);
        ...
        var AppInsights = (function () {
            function AppInsights(config) {
                ...
                var configGetters = {
                    ...
                    emitLineDelimited~/Scriptson: function () { return _this.config.emitLineDelimited~/Scriptson; },
    ...
    (function (ApplicationInsights) {
        ...
        var Initialization = (function () {
            ...
            Initialization.getDefaultConfig = function (config) {
                ...
                config.emitLineDelimited~/Scriptson = ApplicationInsights.Util.stringToBoolOrDefault(config.emitLineDelimited~/Scriptson);
...
(function (Microsoft) {
    ...
    (function (ApplicationInsights) {
        "use strict";
        try {
            if (typeof window !== "undefined" && typeof ~/ScriptsON !== "undefined") {
            ...
            Microsoft.ApplicationInsights._InternalLogging.warnToConsole('Failed to initialize AppInsights ~/Scripts SDK: ' + e.message);
        }
    })(ApplicationInsights = Microsoft.ApplicationInsights || (Microsoft.ApplicationInsights = {}));
})(Microsoft || (Microsoft = {}));
/// <reference path="PageViewData.ts" />
